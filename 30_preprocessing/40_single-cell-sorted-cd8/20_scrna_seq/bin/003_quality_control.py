...
"""
Usage:
  003_quality_control.py --adata_denoised=<adata_denoised>[options]
...
# mitochondrial genes
adata_denoised.var["mt"] = adata_denoised.var_names.str.startswith("mt-")
...
adata_merged = adata_denoised[(~adata_denoised.obs.outlier) & (~adata_denoised.obs.mt_outlier)].copy()

print(f"Number of cells after filtering of low quality cells: {adata_denoised.n_obs}")

# Save adata nodoublet
adata_denoised.write_h5ad("adata_filtered_denoised.h5ad")
